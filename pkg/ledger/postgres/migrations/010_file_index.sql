CREATE TABLE IF NOT EXISTS llm_file_index (
    ...
    file_id TEXT NOT NULL
        CHECK (octet_length(file_id) BETWEEN 1 AND 512),
    ...
    purpose TEXT NOT NULL
        CHECK (octet_length(purpose) <= 256),
...
SELECT owner_scope, 'file', resource_id, 0,
       FLOOR(EXTRACT(EPOCH FROM bound_at))::BIGINT, NULL, '', ''
